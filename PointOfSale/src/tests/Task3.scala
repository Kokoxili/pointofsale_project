...
//    assert(compareDoubles(testSelfCheckout.itemsInCart()(0).price(), 0.0))
    ...
    assert(testSelfCheckout.itemsInCart()(0).description() == "error")
    assert(compareDoubles(testSelfCheckout.itemsInCart()(0).price(), 0.0))
    ...
    assert(testSelfCheckout.itemsInCart()(3).description() == "rtx3060")
    assert(compareDoubles(testSelfCheckout.itemsInCart()(3).price(), 1000))
